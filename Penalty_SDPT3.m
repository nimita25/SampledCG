function [fn_val, sol_MC] = Penalty_SDPT3(InputType, InputData, e1)
tic;
...
nsamples = 10;
R = mvnrnd(zeros(n,1),sol_SDP{1},nsamples);
m = -10000;
for i = 1:nsamples
    x = sign(R(i,:));
    tmp = x*C*x';
...
fileID = fopen('Output/Output_SDPT3.txt','a');
fprintf(fileID,'\n');
