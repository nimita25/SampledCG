function [] = Test_MaxCut_CGAL(data)
...
maxcut_data = data; % you can choose other data files as well
...
P = load(['./FilesMaxCut/data/',maxcut_data]);

n = size(P.Problem.A,1);
C = spdiags(P.Problem.A*ones(n,1),0,n,n) - P.Problem.A;
