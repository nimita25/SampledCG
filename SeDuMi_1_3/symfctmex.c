...
/* ------------------------------------------------------------
   ...
   ------------------------------------------------------------ */
int sfinit_(double *m, double *Xjc,  double *xadj, double *adjncy,
        double *perm, double *invp, double *colcnt, double *nnzl, 
        int *nsub, int *nsuper, int *snode, int *xsuper,
        int *iwsiz, int *iwork, int *flag);

int symfct_(double *m, double *Xjc,  double *xadj, double *adjncy,
        double *perm, double *invp, double *colcnt, 
        int *nsuper, int *xsuper, int *snode, int *nsub,
        int *xlindx, int *Lir, int *Ljc,
        int *iwsiz, int *iwork, int *flag);
